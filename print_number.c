 ...
 * Return: integer that contains the length of string
*/
int _strlen(char *s)
{
    int i = 0;
...
int print_number_right_shift(char *str, params_t *params)
{
    ...
    neg= 0;
    if ((params->plus_flag && !neg) || (!params->plus_flag && params->space_flag && !neg2))
    i++;
...
{
unsingned int n = 0, neg, neg2, i = _strlen(str);
char pad_char = ' ';
